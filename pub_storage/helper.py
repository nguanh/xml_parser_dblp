...
def parse_authors(input):
    ...
    for author in authors_list:
        ...
        if( num_names == 1):
            ...
            names['block'] = norm_last_name + "," + norm_first_name
            #TODO generate alias
            #TODO brauchen überhaupt aliase generiert werden?
