...
class TestParse_authors(TestCase):
    def test_parse_authors1(self):
        name = parse_authors("Walter Vogler;")
    ...
    def test_parse_authors2(self):
        test = parse_authors("Richard Müller 0001;Alexander S. szalay;")
        name = parse_authors("Richard Müller 0001;")
    ...
    def test_parse_authors3(self):
        name = parse_authors("Alexander S. szalay 0501;")
    ...
    def test_parse_authors5(self):
        name = parse_authors("Peter van der Stok;")
    ...
    def test_parse_authors6(self):
        name = parse_authors("Yi-Ping Phoebe Chen;")
    ...
    def test_parse_authors7(self):
        name = parse_authors("Jóhanna V. Gísladóttir;")
    ...
    def test_parse_authors8(self):
        name = parse_authors("Andreas Giskeødegård;")
    ...
    def test_parse_authors9(self):
        name = parse_authors("Ola R. Snøve Jr;")
